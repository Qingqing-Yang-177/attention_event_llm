...
#SBATCH --output=/scratch/qy775/attention_event/scripts/slurm_out/slurm%j.out
#SBATCH --gres=gpu:2
...
python /scratch/qy775/attention_event/scripts/attention_event_seg.py "$text_tested" "$check_punct"
